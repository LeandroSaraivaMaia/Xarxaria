...
<3,Une massue en pierre,3>(Votre force passe à 3) pour <1,4 pièce d''or,14;-4>
<4,Une casquette de mineur en pierre,1>(armure + 1) pour <1,2 pièce d''or,14;-2>
<3,Une dague en pierre,2>(Votre force passe à 2) pour <1,2 pièce d''or,14;-2>
<1,Une étrange perle luisante,15;1> pour <1,1 pièce d''or,14;-1>
...
-- Page 23 temporaire de fin de version
